...
export const GUIAS = [
  ...
  { id: 'vancouver', sku: '11', tipo: 'citacion', precio: 139, nombre: 'Cita como se cita en salud · Vancouver', kicker: 'Normas Vancouver', resumen: 'Estilo Vancouver para tesis de salud: citas numéricas, referencias y el formato que piden las revistas médicas.', blogSlug: 'normas-vancouver-como-citar-en-tesis-de-salud-ejemplos' },
  { id: 'chicago', sku: '12', tipo: 'citacion', precio: 139, nombre: 'La nota al pie, bien puesta · Chicago', kicker: 'Normas Chicago', resumen: 'Estilo Chicago: notas al pie, bibliografía y las dos variantes (notas y autor-fecha) con ejemplos.', blogSlug: 'estilo-chicago-notas-al-pie-y-bibliografia-en-tesis' },
  ...
  // Serie por universidad (trámite de titulación; $99, UVM $79)
  { id: 'tesis-unam', sku: 'U1', tipo: 'universidad', precio: 99, nombre: 'Titularte en la UNAM', kicker: 'Titulación UNAM', resumen: 'El trámite de titulación de la UNAM entendido de una vez: del registro del tema a la firma del acta, con formatos, plazos y las diferencias por facultad. 10 módulos + 4 anexos.', universityLanding: '/tesis-unam' },
  { id: 'tesis-ipn', sku: 'U2', tipo: 'universidad', precio: 99, nombre: 'Titularte en el Poli (IPN)', kicker: 'Titulación IPN', resumen: 'El trámite de titulación del IPN paso a paso: opciones por escuela, requisitos, expediente de documentos y examen profesional, con fechas y ventanillas.', universityLanding: '/tesis-ipn' },
  { id: 'tesis-udg', sku: 'U3', tipo: 'universidad', precio: 99, nombre: 'Titularte en la UdeG', kicker: 'Titulación UdeG', resumen: 'La titulación en la Universidad de Guadalajara: modalidades por centro universitario, requisitos, documentos y tiempos del trámite.', universityLanding: '/tesis-udg' },
  { id: 'tesis-uanl', sku: 'U4', tipo: 'universidad', precio: 99, nombre: 'Titularte en la UANL, facultad por facultad', kicker: 'Titulación UANL', resumen: 'La UANL no tiene reglamento general de titulación: cada facultad publica el suyo. Esta guía te lleva por tu facultad, con opciones, documentos y examen.', universityLanding: '/tesis-uanl' },
  { id: 'tesis-buap', sku: 'U5', tipo: 'universidad', precio: 99, nombre: 'Titularte en la BUAP', kicker: 'Titulación BUAP', resumen: 'El trámite de titulación de la BUAP: opciones, requisitos, expediente y examen profesional, con las diferencias por unidad académica.', universityLanding: '/tesis-buap' },
  { id: 'tesis-uv', sku: 'U6', tipo: 'universidad', precio: 99, nombre: 'Titularte en la UV', kicker: 'Titulación UV', resumen: 'La titulación en la Universidad Veracruzana: modalidades por región y facultad, documentos, tiempos y examen del proceso.', universityLanding: '/tesis-uv' },
  { id: 'tesis-uaemex', sku: 'U7', tipo: 'universidad', precio: 99, nombre: 'Titularte en la UAEMéx', kicker: 'Titulación UAEMéx', resumen: 'El trámite de evaluación profesional de la UAEMéx: opciones de titulación, requisitos, documentos y examen, con sus tiempos.', universityLanding: '/tesis-uaemex' },
  { id: 'tesis-uam', sku: 'U8', tipo: 'universidad', precio: 99, nombre: 'Tu proyecto terminal en la UAM', kicker: 'Proyecto terminal UAM', resumen: 'En la UAM el título de licenciatura se obtiene con proyecto terminal, no con tesis. Esta guía cubre ese proceso: registro, documentos y presentación.', universityLanding: '/tesis-uam' },
  { id: 'tesis-tec', sku: 'U9', tipo: 'universidad', precio: 99, nombre: 'La tesis de posgrado en el Tec', kicker: 'Tesis posgrado Tec', resumen: 'En el Tec de Monterrey la tesis vive en posgrado. Guía del proceso de tesis de maestría y doctorado: comité, protocolo, avances y defensa.', universityLanding: '/tesis-tec-monterrey' },
  { id: 'tesis-unitec', sku: 'U10', tipo: 'universidad', precio: 99, nombre: 'Titularte en la UNITEC', kicker: 'Titulación UNITEC', resumen: 'El trámite de titulación de la UNITEC: opciones, requisitos, documentos y examen, con los tiempos de cada campus.', universityLanding: '/tesis-unitec' },
  { id: 'tesis-uvm', sku: 'U11', tipo: 'universidad', precio: 79, nombre: 'Titularte en la UVM', kicker: 'Titulación UVM', resumen: 'El reglamento de titulación de la UVM no es público. Esta guía se apoya en el marco legal de la SEP para exigir el documento a tu campus, con un guion de correo listo para usar.', universityLanding: '/tesis-uvm' },
];
