...
const SalesQuoteCard = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        precioRegular: '',
        descuentoEfectivo: 0, // Sin descuento en efectivo para cotizaciones con tarjeta
                                                ...
                                                <Col xs={6}>
                                                    ...
                                                    <div className="d-flex gap-1">
                                                        <div className="input-group input-group-sm flex-grow-1">
                                                            <Form.Control type="number" value={formData.descuentoEfectivo} disabled className="bg-light" />
                                                            <span className="input-group-text">%</span>
                                                        </div>
                                                    </div>
                                                </Col>
