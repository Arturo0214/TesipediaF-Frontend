...
const offerings = [
  ...
  { icon: <FaSearch />, t: 'Antiplagio Turnitin', d: 'Reporte de originalidad incluido como respaldo de tu trabajo.', to: '/comprar-tesis' },
  { icon: <FaRobot />, t: 'Detección anti-IA', d: '100% humano. Redactado por investigadores, sin contenido generado por IA.', to: '/comprar-tesis' },
