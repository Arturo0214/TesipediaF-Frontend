      ...
      children: [
        {
          ...
          children: [
            ...
            { path: 'admin/contabilidad', element: <LazyPage><AdminPanel /></LazyPage> },
            ...
            { path: 'admin/calendarios', element: <LazyPage><AdminPanel /></LazyPage> },
            { path: 'admin/agentes', element: <LazyPage><AdminPanel /></LazyPage> },
